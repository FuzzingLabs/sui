...
impl Interpreter {
    ...
    fn execute_main(
        ...
        loop {
            ...
            let result =
                current_frame //self
<<<<<<< HEAD:external-crates/move/move-execution/v1/crates/move-vm-runtime/src/interpreter.rs
...
>>>>>>> 1f06a10062 (Coverage):external-crates/move-execution/v0/move-vm/runtime/src/interpreter.rs
            match exit_code {
                ExitCode::Return => {
